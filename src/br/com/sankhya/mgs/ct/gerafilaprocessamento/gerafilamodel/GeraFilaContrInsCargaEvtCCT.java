...
public class GeraFilaContrInsCargaEvtCCT extends GeraFilaSuper implements GeraFila {
    public GeraFilaContrInsCargaEvtCCT(JdbcWrapper jdbcWrapper) {
        super(jdbcWrapper);
    }
    ...
    public boolean executarFilho() throws Exception {
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "CCT");
