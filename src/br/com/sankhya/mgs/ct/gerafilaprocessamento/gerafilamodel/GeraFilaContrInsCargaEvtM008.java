...
public class GeraFilaContrInsCargaEvtM008 extends GeraFilaSuper implements GeraFila {
    public  GeraFilaContrInsCargaEvtM008() {
        super();
    }
    @Override
    public boolean executar() throws Exception {
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "APS");
