...
public class GeraFilaContrInsCargaEvtM022 extends GeraFilaSuper implements GeraFila {
    public GeraFilaContrInsCargaEvtM022(JdbcWrapper jdbcWrapper) {
        super(jdbcWrapper);
    }
    @Override
    public boolean executarFilho() throws Exception {
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "SRV");
