...
public class PrcContrInsCargaEvtDVSub extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtDVSub() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro PrcContrInsCargaEvtDVSub: " + log;
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_DV_SUB");
