...
public class PrcContrInsCargaEvtM007 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtM007() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro prcContrInsCargaEvtM007: " + log;
            ...
            throw new Exception("Erro ao executar procedure prcContrInsCargaEvtM007: " + e);
        } finally {
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_007");
