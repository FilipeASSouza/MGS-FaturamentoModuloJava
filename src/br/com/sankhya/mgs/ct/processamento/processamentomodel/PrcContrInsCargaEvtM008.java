...
public class PrcContrInsCargaEvtM008 extends ProcessarSuper implements Processar {
    private String mensagem;

    public PrcContrInsCargaEvtM008() {
        super();
    }
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_008");
