...
public class PrcContrInsCargaEvtM010 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtM010() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro prcContrInsCargaEvtM010: " + log;
            ...
            throw new Exception("Erro ao executar procedure prcContrInsCargaEvtM010: " + e);
        } finally {
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_010");
