...
public class PrcContrInsCargaEvtM021 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtM021() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro prcContrInsCargaEvtM021: " + log;
            ...
            throw new Exception("Erro ao executar procedure prcContrInsCargaEvtM021: " + e);
        } finally {
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_021");
