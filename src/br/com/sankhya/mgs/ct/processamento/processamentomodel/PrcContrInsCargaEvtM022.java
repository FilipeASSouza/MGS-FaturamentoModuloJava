...
public class PrcContrInsCargaEvtM022 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtM022() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro prcContrInsCargaEvtM022: " + log;
            ...
            throw new Exception("Erro ao executar procedure prcContrInsCargaEvtM022: " + e);
        } finally {
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_022");
