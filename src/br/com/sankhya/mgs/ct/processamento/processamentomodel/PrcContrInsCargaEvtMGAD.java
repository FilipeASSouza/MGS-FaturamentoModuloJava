...
public class PrcContrInsCargaEvtMGAD extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtMGAD() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro PrcContrInsCargaEvtMGAD: " + log;
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_GAD");
