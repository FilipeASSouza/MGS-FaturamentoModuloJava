...
public class PrcContrInsCargaEvtMMT2 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtMMT2() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro PrcContrInsCargaEvtMMT2: " + log;
            ...
            throw new Exception("Erro ao executar procedure PrcContrInsCargaEvtMMT2: " + e);
        } finally {
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_MT2");
