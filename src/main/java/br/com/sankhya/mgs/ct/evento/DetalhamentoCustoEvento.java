...
import br.com.sankhya.mgs.ct.controller.DetalhamentoCustoController;
 ...
 * Chave: NUEVTMENSAL
 */
public class DetalhamentoCustoEvento implements EventoProgramavelJava {
    private DetalhamentoCustoController controller = new DetalhamentoCustoController();
