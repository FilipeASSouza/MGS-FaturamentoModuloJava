...
import br.com.sankhya.mgs.ct.controller.TaxaContratoController;
 ...
 * Chave: NUCONTRTAXA
 */
public class TaxaContratoEvento implements EventoProgramavelJava {
    private TaxaContratoController controller = new TaxaContratoController();
