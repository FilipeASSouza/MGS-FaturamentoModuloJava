...
import br.com.sankhya.mgs.ct.controller.TributosContratoController;
 ...
 */
public class TributosContratoEvento implements EventoProgramavelJava {
    private TributosContratoController controller = new TributosContratoController();
