...
public class GeraFilaContrInsCargaEvtM001 extends GeraFilaSuper implements GeraFila {
    public GeraFilaContrInsCargaEvtM001(JdbcWrapper jdbcWrapper) {
        super(jdbcWrapper);
    }
    ...
    public boolean executarFilho() throws Exception {
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "PST");
