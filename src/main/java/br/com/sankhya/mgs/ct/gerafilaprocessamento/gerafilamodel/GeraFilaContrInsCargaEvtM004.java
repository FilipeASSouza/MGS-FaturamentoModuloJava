...
public class GeraFilaContrInsCargaEvtM004 extends GeraFilaSuper implements GeraFila {
    public GeraFilaContrInsCargaEvtM004(JdbcWrapper jdbcWrapper) {
        super(jdbcWrapper);
    }
    ...
    public boolean executarFilho() throws Exception {
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "FER");
