...
public class GeraFilaContrInsCargaEvtMGAD extends GeraFilaSuper implements GeraFila {
    public GeraFilaContrInsCargaEvtMGAD(JdbcWrapper jdbcWrapper) {
        super(jdbcWrapper);
    }
    ...
    public boolean executarFilho() throws Exception {
        ...
        String parametroPeriodoApuracao = (String) parametrosMetrica.get("PERIODOAPURACAOGESTAO");
        ...
        mapParametrosChave.put("V_TP_APONTAMENTO", "GDS");
