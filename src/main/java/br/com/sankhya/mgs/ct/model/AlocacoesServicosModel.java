...
public class AlocacoesServicosModel {
    ...
    public void validaCamposUpdate(HashMap<String, Object[]> campos) throws Exception {
        ...
        if (campos.containsKey("NUALOCASERV")) {
        ...
        if (campos.containsKey("QTDEALOCACAO")) {
            mensagemErro += "Campo Qtde Alocada não pode ser modificado. ";
        }
        if (campos.containsKey("VLRUNITARIO")) {
            mensagemErro += "Campo Valor Unitário não pode ser modificado. ";
        }
        if (campos.containsKey("VLRTOTAL")) {
            mensagemErro += "Campo Valor Total não pode ser modificado. ";
        }
