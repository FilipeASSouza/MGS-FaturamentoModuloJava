...
public class PrcContrInsCargaEvtM011 extends ProcessarSuper implements Processar {

    public PrcContrInsCargaEvtM011() {
        super();
    }
        ...
        try {
            ...
            if (!integracaoSalva) {
                ...
                if (BigDecimal.ONE.equals(sucesso)) {
                    ...
                    executado = false;
                    mensagem = "Erro prcContrInsCargaEvtM011: " + log;
                    IntegracaoDetalhaCustoModel.atualizaComplemento(numeroUnicoIntegracao, "E");//erro
                }
            }
        } catch (Exception e) {
            throw new Exception("Erro ao executar procedure prcContrInsCargaEvtM011: " + e);
        } finally {
            super.finalizar();
        }
        return executado;
    ...
    private ProcedureCaller getProcedureCaller(JdbcWrapper jdbc, Map<String, String> parametrosExecutacao) throws Exception {
        ProcedureCaller caller = new ProcedureCaller("CONTR_INS_CARGA_EVT_M_011");
