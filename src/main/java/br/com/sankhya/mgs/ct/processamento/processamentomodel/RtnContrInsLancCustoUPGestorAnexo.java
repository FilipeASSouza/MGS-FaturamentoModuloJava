...
public class RtnContrInsLancCustoUPGestorAnexo extends ProcessarSuper implements Processar {
    ...
    public boolean executar() throws Exception {
        ...
        try {
            ...
            String pastaDeModelosParaImpressao = JapeFactory.dao("ParametroSistema").findOne("CHAVE = 'SERVDIRMOD' AND CODUSU = 0").asString("TEXTO");
            ...
            parametrosRelatorio.put("PDIR_MODELO", pastaDeModelosParaImpressao);
